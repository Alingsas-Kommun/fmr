                ...
                'fields' => [
                    [
                        'fields' => [
                            ...
                            [
                                'id' => 'site_icon',
                                'label' => __('Site Icon', 'fmr'),
                                'type' => 'image',
                                'cols' => 4,
                                'description' => __('Site icon to display in the browser tab', 'fmr'),
                                'optional' => true,
                            ],
                        ],
                    ],
                ...
                'fields' => [
                    [
                        'fields' => [
                            ...
                            [
                                'id' => 'show_person_image',
                                'label' => __('Show Person Image', 'fmr'),
                                'type' => 'checkbox',
                                'default' => true,
                                'cols' => 4,
                                'on_label' => __('Yes', 'fmr'),
                                'off_label' => __('No', 'fmr'),
                                'description' => __('Display person image', 'fmr'),
                            ],
                        ],
                    ],
                ],
