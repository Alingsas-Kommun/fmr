function relationHandler(config, existingData = []) {
    return {
        config: config,
        ...
        showValidationError() {
            // Simple validation feedback - could be enhanced with more specific messages
        ...
        getRelationTitle(relation) {
            ...
            return titleField ? relation[titleField.key] || 'Untitled' : 'Untitled';
        },
