    ...
    @noposts
        <main class="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
            <div class="text-center">
                <p class="font-semibold text-emerald-600 text-2xl">{!! __('404', 'fmr') !!}</p>
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="{!! route('homepage') !!}" class="rounded-md bg-emerald-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-emerald-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">
                        {!! __('Go back home', 'fmr') !!}
                    </a>
