            ...
            <div class="py-4">
                <form action="{{ url()->current() }}" method="get" class="flex items-center gap-6">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="relative">
                            <select name="type" id="type" class="appearance-none block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm bg-gray-100" onchange="this.form.submit()">
